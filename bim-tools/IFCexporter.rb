...
UI.menu("PlugIns").add_item("IFC Export(STEP)") {
  export
}
...
#in de vorige rij moet voor elke wand een nummer worden opgenomen
		...
		faces.each { |face|
			if face.attribute_dictionary "ifc"
				...
				grossSideArea = "11.500" #opp zijkant
				netSideArea = "10.450" #opp zijkant - 10%?
				grossVolume = "3.450" #inhoud
				netVolume = "3.135" #inhoud - 10%?
				grossFootprintArea = "1.500" #opp bodem
				shaperepresentationX1 = "0." # was eigenlijk "150."
				shaperepresentationX2 = "0." # was eigenlijk "150."
				...
				@export_content << "#" + id_33 + " = IFCMATERIAL('Name of the material used for the wall');"
...
if not file_loaded?(File.basename(__FILE__))
  UI.menu("File").add_item("IFCexporter..."){IFCexporter.new()}
end#if
